...
console.log("Er zijn " + numberMovies + " films aanwezig");
...
lastActor = movies[lastMovie].actors.length - 1;
...
if (selectedMovie.rating > 8) {
    console.log("Topper!");
} else if (selectedMovie.rating <= 8 && selectedMovie.rating > 6) {
    console.log("Kijktip!")
